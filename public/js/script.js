$(document).ready(function() {
    $('addnewForm').click(function(e) {
        $('.panel-full').clone().appendTo('container');
    });
});

$(function () {
    $('#addnewForm').click(function () {
        var num     = $('.panel panel-default').length, // Checks to see how many "duplicatable" input fields we currently have
        ...
        */
        ...
        if (newNum == 5)
            $('#addnewForm').attr('disabled', true).prop('value', "You've reached the limit"); // value here updates the text in the 'add' button when the limit is reached
        ...
        if (newNum == 5)
            $('#addnewForm').attr('disabled', true).text("You've reached the limit"); // value here updates the text in the 'add' button when the limit is reached
    });
    ...
    $('#addnewForm').attr('disabled', false);
